...
const char *mass_storage_controller_subclass_mame(uint8_t subclass_code) {
    ...
    return to_hstring16(subclass_code);
}
...
const char *get_subclass_name(uint8_t class_code, uint8_t subclass_code) {
    switch (class_code) {
    case 0x01:
        return mass_storage_controller_subclass_mame(subclass_code);
    case 0x03:
        switch (subclass_code) {
        case 0x00:
